...
### 算法相关网站及文章
[1、LeetCode](https://leetcode-cn.com/explore/)

[2、赛码网](https://www.acmcoder.com/index)

[3、要面试了，数据结构和算法太弱怎么办](https://www.acmcoder.com/index)



### 一些好的学习网站

[1、正则表达式在线验证](https://regexr.com/)

[2、CSS3渐变背景代码生成工具](http://www.internetke.com/jsEffects/2014120803/)

[3、CSS阴影快速生成及预览](https://www.html.cn/tool/css3Preview/Text-Shadow.html)

[4、在线工具，程序员的工具箱](https://tool.lu/)

[5、静态资源托管库](https://cdn.baomitu.com/)

[6、ScriptOJ-Web 前端开发评测系统](http://scriptoj.mangojuice.top/)

[7、30秒就能理解的JavaScript优秀代码](http://caibaojian.com/30-seconds-of-code.html)

[8、web在线闯关的网站](https://www.freecodecamp.one/)

[9、在线工具](https://tool.oschina.net/)

### 在线书籍

[1、js函数式编程](https://llh911001.gitbooks.io/mostly-adequate-guide-chinese/content/)

[2、深入浅出webpack](http://webpack.wuhaolin.cn/)

### 一些好的nodejs学习地址

[1、一起学 Node.js](https://github.com/nswbmw/N-blog)

[2、Node.js 最佳实践](https://github.com/goldbergyoni/nodebestpractices/blob/master/README.chinese.md)

[3、nodejs概述](http://javascript.ruanyifeng.com/nodejs/basic.html#)